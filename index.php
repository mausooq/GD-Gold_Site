  ...
  <body class="content">
    ...
    <header id="header">
      ...
      <div class="menu">
        ...
        <a href="container3" onclick="closeMenu()">COLLECTIONS</a>
        <a href="#gallery" onclick="closeMenu()">PLANS</a>
        <a href="#contactus" onclick="closeMenu()">CONTACT</a>
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item active">
          <div class="d-block w-100 vh-100 bg-customDark text-white d-flex justify-content-center align-items-center backgroundImage1">
            ...
            <div class="homePageText">
              ...
              <a href="#" class="btn btn-outline-warning golden_BG">Explore Now</a>
            </div>
          </div>
        </div>
        <!-- Slide 2 -->
        ...
        <div class="carousel-item">
          <div class="d-block w-100 vh-100 bg-customDark text-white d-flex justify-content-center align-items-center backgroundImage4">
            ...
            <div class="homePageImg">
              <img src="./images/chain11.png" alt="" />
            </div>
            <div class="homePageText">
              <h2>
                A Small Investment <br />
    ...
    <div   class="container3 text-center">
      ...
      <div  data-aos-delay="100"  data-aos="fade-up" style="margin: 0px" class="UnderLine text-center"><p></p></div>
...
<div class="viewMore text-center"><a href="" class="btn  bg-golden ">View More Collections</a></div>
        ...
        <div class="carousel-inner">
            ...
            if ($testi_result === FALSE) {
                ...
                while ($row = $testi_result->fetch_assoc()) {
                    ...
                    echo '<img style="border-radius:0;height:10px" src="./images/ratingStar.png">';
                    echo '</div>';
                    echo '</div>';
    ...
    <footer class="site-footer">
      <div class="footer-content">
        ...
        <nav class="footer-nav third-column">
          <ul>
            <li><a href="https://legacyevent.solutions/">Home</a></li>
            |&nbsp;&nbsp;
            <li><a href="https://legacyevent.solutions/privacy-policy/"> About us</a></li>
            |&nbsp;&nbsp;
            <li><a href="https://legacyevent.solutions/contact">Collections</a></li>
            |&nbsp;&nbsp;
            <li><a href="https://legacyevent.solutions/privacy-policy/">Plans</a></li>
          </ul>
